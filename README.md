...
### **[Click to Download Latest Version](https://github.com/RamaLingeswaraRao950/CalVault/releases/latest)**
...
### 🔹 Installation Steps
```bash
git clone https://github.com/RamaLingeswaraRao950/CalVault.git
```
- Open **Android Studio** and build the project.  
- Install the APK on your **Android device or emulator**.  

### 🔹 Build From Source (CLI)
- Install **Android Studio** (or Android SDK command-line tools) and make sure the **Android SDK** is installed.
- Create `local.properties` from `local.properties.example` and set `sdk.dir` to your SDK path.
- Install the Android SDK Platform for the `compileSdk` configured in `app/build.gradle.kts` (currently `compileSdk = 36`).
...
**GitHub**: [RamaLingeswaraRao950](https://github.com/RamaLingeswaraRao950)  
